...
from smartdashcam_msgs.msg import ObjectCount, ObjectCounts
...
class DebugNode(LifecycleNode):
    def __init__(self) -> None:
        ...
        self.confidence_thresholds = {
            ...
            'genangan': 0.2,
            'kaki_empat': 0.5,
            'guardrail_miring': 0.2,
            'guardrail_hilang': 0.2,
            'kendaraan_berhenti': 0.25,
            'lubang': 0.1,
            'motor': 0.3,
            'orang_dipinggir_tol': 0.4,
            'pecahan_ban': 0.3,
            'pohon': 0.3,
            'sampah_kardus': 0.2,
            'stickcone_roboh': 0.2,
    ...
    def on_configure(self, state: LifecycleState) -> TransitionCallbackReturn:
        ...
        self._counts_mqtt_pub = self.create_publisher(String, "/smartdashcam/debug_counter", 10)
    ...
    def detections_cb(self, img_msg: Image, detection_msg: DetectionArray) -> None:
        ...
        for detection in detection_msg.detections:
            class_name = detection.class_name
            confidence_threshold = self.confidence_thresholds.get(class_name, 0.3)
